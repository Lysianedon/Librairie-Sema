<template>
    <div class="footer">
      <div class="blocks block-one">
        <router-link to="/" class="links">A propos</router-link>
        <router-link to="/aide" class="links">Aide</router-link>
      ...
      <div class="blocks block-two">
        ...
        <div class="icons">
          ...
          <a href="https://github.com/Lysianedon" target="_blank" rel="noopener noreferrer">
